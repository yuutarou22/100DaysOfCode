...
# print (tmpString)
# print ("len(tmpString) = ", len(tmpString)) # 文字列の長さ
# print ("tmpString.find(\"d\") = ", tmpString.find("d")) # 文字の位置

# print ("文字列の切り出し"
# print ("tmpString[2]", tmpString[2])
# print ("tmpString[2:5]", tmpString[2:5])
# print ("tmpString[:5]", tmpString[:5])
# print ("tmpString[2:-1]", tmpString[2:-1])
